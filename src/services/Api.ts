...
export class Api {
  ...
  post = (uri: Uri, body?: Json, options: RequestOptions = RequestOptions.Json, transform?: (r: any) => any): Promise<Response> =>
    this.provider.execute({ uri, verb: HttpVerb.Post, body, transform, options });

  put = (uri: Uri, body?: Json, options: RequestOptions = RequestOptions.Json, transform?: (r: any) => any): Promise<Response> =>
    this.provider.execute({ uri, verb: HttpVerb.Put, body, transform, options });

  patch = (uri: Uri, body?: Json, options: RequestOptions = RequestOptions.Json, transform?: (r: any) => any): Promise<Response> =>
