...
export const toPassMatcher = (result: MatcherResult): MatcherResult =>
  match(result)
    .not(
      c => c.pass,
...
export const toPassMatcherWith = (result: MatcherResult, message: Message<MatcherResult>): MatcherResult =>
  match(result)
    .not(
      c => c.pass,
      c => Passes.No(c.message())
