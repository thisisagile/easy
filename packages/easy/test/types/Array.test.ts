...
describe("toObject", () => {
  ...
  describe("array", () => {
    ...
    test.each([
      ...
      ["2nd array matches with default 1st key", first, second, undefined, "id", first.length, {
        id: 3,
        first: "Sander",
        last: "H"
      }],
      ["2nd array matches with default 2nd key", first, second, "id", undefined, first.length, {
        id: 3,
        first: "Sander",
        last: "H"
      }],
      ["2nd array matches with two default keys", first, second, undefined, undefined, first.length, {
        id: 3,
        first: "Sander",
        last: "H"
      }],
      ["2nd array matches with keys id", first, second, "id", "id", first.length, {
        id: 3,
        first: "Sander",
        last: "H"
      }],
      ["2nd array with non-existing key", first, second, "", "last", first.length, first[0]],
      ["2nd array matches", first, [{ id: 3, last: "Ho" }], "id", "id", first.length, {
        id: 3,
        first: "Sander",
        last: "Ho"
      }],
      ["2nd array matches on another key", first, [{ key: 3, last: "Ho" }], "id", "key", first.length, {
        id: 3,
        first: "Sander",
        last: "Ho"
      }]
