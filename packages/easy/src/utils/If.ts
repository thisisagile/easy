...
export const ifDefined = <Out, In = unknown>(o: In, f: Construct<Out, NonNullable<In>>, alt?: Construct<Out, In>): Optional<Out> => (isDefined(o) ? ofConstruct(f, o)  : ofConstruct(alt, o));
