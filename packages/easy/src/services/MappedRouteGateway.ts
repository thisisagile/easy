...
export class MappedRouteGateway<U extends Uri> extends RouteGateway<U> {
  constructor(readonly route: Func<U>, readonly routeId: Func<U>, readonly map = new Mapper(), readonly api: Api = new Api()) {
